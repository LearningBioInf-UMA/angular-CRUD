...
Después ya podemos crear nuestro primer proyecto en Angular. Para este tutorial vamos a implementar una interfaz CRUD *(Create-Read-Update-Delete)*. Para crear un proyecto nuevo ejecutamos: ````np new angular-crud ```` *(angular-crud = Nombre del proyecto)*.
